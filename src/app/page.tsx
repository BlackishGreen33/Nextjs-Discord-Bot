...
const DISCORD_BOT_INVITE_PERMISSIONS = '60416';
    ...
    <main className="flex h-dvh flex-col items-center p-24">
      <section className="flex flex-col items-center rounded-xl bg-gray-900 px-8 py-16 shadow-2xl">
        ...
        <Link
          ...
          href={`https://discord.com/api/oauth2/authorize?client_id=${clientApplicationId}&permissions=${DISCORD_BOT_INVITE_PERMISSIONS}&scope=bot%20applications.commands`}
          target="_blank"
